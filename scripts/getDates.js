...
let url = `https://api.openweathermap.org/data/3.0/onecall?lat=27.9288&lon=84.4096&units=metric&exclude={daily,hourly}&appid=${apiKey}`;
...
function displayResults(data){
    currentTemp.innerHTML= `${data.current.temp} 'C`
